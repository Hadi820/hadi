...
-- Update team members reward balance based on ledger entries
UPDATE team_members SET reward_balance = 150000 WHERE id = 'TM001';
UPDATE team_members SET reward_balance = 100000 WHERE id = 'TM003';
